...
wysihtml5.browser = (function() {
  ...
  return {
    ...
    /**
     * Chrome & Safari only fire the ondrop/ondragend/... event when the ondragover event is cancelled
     * with event.preventDefault
     * Firefox 3.6 fires those event anyway, but the mozilla doc says that the dragover/dragenter event needs
     * to be cancelled
     */
