...
KeyTable = function ( oInit )
{
	...
	/*
	 * Variable: block
	 * Purpose:  Flag whether or not KeyTable event should be processed
	 ...
	 * Scope:    KeyTable - public
	 * Notes:    This object contains all the public methods for adding and removing event - these
	 ...
	 * Purpose:  Flag for should KeyTable capture key event or not
	 * Scope:    KeyTable - private
	 */
	...
	function _fnEventAddTemplate( sKey )
	{
		 ...
		 *         or
		 *           1. int:x - x coord. of target cell (can be null for live event)
		 *           2. int:y - y coord. of target cell (can be null for live event)
	...
	function _fnEventRemoveTemplate( sKey )
	{
		 ...
		 * Returns:  int: - number of event removed
	 ...
	 * Returns:  int: - number of matching event removed
	 ...
	 * Purpose:  Look thought the event cache and fire off the event of interest
	 * Returns:  int:iFired - number of event fired
	 * Inputs:   string:sType - type of event to look for
	 ...
	 * Purpose:  Remove focus from a cell and fire any blur event which are attached
	 * Returns:  -
	...
	/*
	 * Function: _fnKey
	 * Purpose:  Deal with a key event, be it moving the focus or return etc.
	 ...
	 * Purpose:  Start capturing key event for this table
	 * Returns:  -
	 * Inputs:   -
	 */
	function _fnCaptureKeys( )
	 ...
	 * Purpose:  Stop capturing key event for this table
	 * Returns:  -
	 * Inputs:   -
	 */
	function _fnReleaseKeys( )
