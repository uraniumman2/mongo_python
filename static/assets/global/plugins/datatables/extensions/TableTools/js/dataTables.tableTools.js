...
TableTools = function( oDT, oOpts )
{
	...
	this.s = {
		 ...
		 * master which controls event (row selection etc)
		 *  @property master
		 *  @type	 boolean
		 *  @default  false
		 */
	...
	this.dom = {
		...
		"collection": {
			...
			/**
			 * Background display to provide focus and capture event
			 *  @property background
			 *  @type	 node
			 *  @default  null
			 */
...
TableTools.prototype = {
	...
	/**
	 * Configure a text based button for interaction event
	...
	/**
	 * Configure a flash based button for interaction event
